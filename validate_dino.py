...
if __name__ == "__main__":
    ...
    parser.add_argument("--arch", type=str, default="Dino:Vit-B/14")
    parser.add_argument(
        "--ckpt", type=str, default="checkpoints/Dino_early/model_epoch_best.pth"
    )

    parser.add_argument("--result_folder", type=str, default="result_dino", help="")
